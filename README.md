# Temperature & Humidity for Arduino Nano33 BLE sensor pack
This project is a starting point for testing two different configuration for the Arduino Versions
